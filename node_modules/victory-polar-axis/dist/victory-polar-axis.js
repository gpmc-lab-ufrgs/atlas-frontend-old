...
_defineProperty(VictoryPolarAxis, "propTypes", _objectSpread(_objectSpread({}, victory_core__WEBPACK_IMPORTED_MODULE_5__.baseProps), {}, {
  axisAngle: (prop_types__WEBPACK_IMPORTED_MODULE_3___default().number),
  axisComponent: (prop_types__WEBPACK_IMPORTED_MODULE_3___default().element),
  axisLabelComponent: (prop_types__WEBPACK_IMPORTED_MODULE_3___default().element),
  axisValue: prop_types__WEBPACK_IMPORTED_MODULE_3___default().oneOfType([(prop_types__WEBPACK_IMPORTED_MODULE_3___default().number), (prop_types__WEBPACK_IMPORTED_MODULE_3___default().string), (prop_types__WEBPACK_IMPORTED_MODULE_3___default().object)]),
  categories: prop_types__WEBPACK_IMPORTED_MODULE_3___default().oneOfType([prop_types__WEBPACK_IMPORTED_MODULE_3___default().arrayOf((prop_types__WEBPACK_IMPORTED_MODULE_3___default().string)), prop_types__WEBPACK_IMPORTED_MODULE_3___default().shape({
    x: prop_types__WEBPACK_IMPORTED_MODULE_3___default().arrayOf((prop_types__WEBPACK_IMPORTED_MODULE_3___default().string)),
    y: prop_types__WEBPACK_IMPORTED_MODULE_3___default().arrayOf((prop_types__WEBPACK_IMPORTED_MODULE_3___default().string))
  })]),
  circularAxisComponent: (prop_types__WEBPACK_IMPORTED_MODULE_3___default().element),
  circularGridComponent: (prop_types__WEBPACK_IMPORTED_MODULE_3___default().element),
  containerComponent: (prop_types__WEBPACK_IMPORTED_MODULE_3___default().element),
  dependentAxis: (prop_types__WEBPACK_IMPORTED_MODULE_3___default().bool),
  disableInlineStyles: (prop_types__WEBPACK_IMPORTED_MODULE_3___default().bool),
  ...
  events: prop_types__WEBPACK_IMPORTED_MODULE_3___default().arrayOf(prop_types__WEBPACK_IMPORTED_MODULE_3___default().shape({
    target: prop_types__WEBPACK_IMPORTED_MODULE_3___default().oneOf(["axis", "axisLabel", "grid", "ticks", "tickLabels"]),
    eventKey: prop_types__WEBPACK_IMPORTED_MODULE_3___default().oneOfType([(prop_types__WEBPACK_IMPORTED_MODULE_3___default().array), victory_core__WEBPACK_IMPORTED_MODULE_6__.allOfType([victory_core__WEBPACK_IMPORTED_MODULE_6__.integer, victory_core__WEBPACK_IMPORTED_MODULE_6__.nonNegative]), (prop_types__WEBPACK_IMPORTED_MODULE_3___default().string)]),
    eventHandlers: (prop_types__WEBPACK_IMPORTED_MODULE_3___default().object)
  })),
  gridComponent: (prop_types__WEBPACK_IMPORTED_MODULE_3___default().element),
  ...
  stringMap: (prop_types__WEBPACK_IMPORTED_MODULE_3___default().object),
  style: prop_types__WEBPACK_IMPORTED_MODULE_3___default().shape({
    parent: (prop_types__WEBPACK_IMPORTED_MODULE_3___default().object),
    axis: (prop_types__WEBPACK_IMPORTED_MODULE_3___default().object),
    axisLabel: (prop_types__WEBPACK_IMPORTED_MODULE_3___default().object),
    grid: (prop_types__WEBPACK_IMPORTED_MODULE_3___default().object),
    ticks: (prop_types__WEBPACK_IMPORTED_MODULE_3___default().object),
    tickLabels: (prop_types__WEBPACK_IMPORTED_MODULE_3___default().object)
  }),
  tickComponent: (prop_types__WEBPACK_IMPORTED_MODULE_3___default().element),
  ...
  tickFormat: prop_types__WEBPACK_IMPORTED_MODULE_3___default().oneOfType([(prop_types__WEBPACK_IMPORTED_MODULE_3___default().func), victory_core__WEBPACK_IMPORTED_MODULE_6__.homogeneousArray]),
  tickLabelComponent: (prop_types__WEBPACK_IMPORTED_MODULE_3___default().element),
...
_defineProperty(VictoryPolarAxis, "getDomain", victory_core__WEBPACK_IMPORTED_MODULE_4__.getDomain);

_defineProperty(VictoryPolarAxis, "getAxis", victory_core__WEBPACK_IMPORTED_MODULE_4__.getAxis);
...
var getArcPath = function (props) {
  ...
  var x1 = cx + r * Math.cos(_victory_util_helpers__WEBPACK_IMPORTED_MODULE_3__.degreesToRadians(startAngle));
  var y1 = cy - r * Math.sin(_victory_util_helpers__WEBPACK_IMPORTED_MODULE_3__.degreesToRadians(startAngle));
  var x2 = cx + r * Math.cos(_victory_util_helpers__WEBPACK_IMPORTED_MODULE_3__.degreesToRadians(halfAngle));
  var y2 = cy - r * Math.sin(_victory_util_helpers__WEBPACK_IMPORTED_MODULE_3__.degreesToRadians(halfAngle));
  var x3 = cx + r * Math.cos(_victory_util_helpers__WEBPACK_IMPORTED_MODULE_3__.degreesToRadians(endAngle));
  var y3 = cy - r * Math.sin(_victory_util_helpers__WEBPACK_IMPORTED_MODULE_3__.degreesToRadians(endAngle));
...
Arc.propTypes = _objectSpread(_objectSpread({}, _victory_util_common_props__WEBPACK_IMPORTED_MODULE_4__.primitiveProps), {}, {
  closedPath: (prop_types__WEBPACK_IMPORTED_MODULE_2___default().bool),
  cx: (prop_types__WEBPACK_IMPORTED_MODULE_2___default().number),
  cy: (prop_types__WEBPACK_IMPORTED_MODULE_2___default().number),
  datum: (prop_types__WEBPACK_IMPORTED_MODULE_2___default().any),
  endAngle: (prop_types__WEBPACK_IMPORTED_MODULE_2___default().number),
  pathComponent: (prop_types__WEBPACK_IMPORTED_MODULE_2___default().element),
  r: (prop_types__WEBPACK_IMPORTED_MODULE_2___default().number),
  startAngle: (prop_types__WEBPACK_IMPORTED_MODULE_2___default().number)
});
Arc.defaultProps = {
