...
var VictoryContainer = /*#__PURE__*/function (_React$Component) {
  ...
  _createClass(VictoryContainer, [{
    ...
    value: function renderContainer(props, svgProps, style) {
      ...
      return /*#__PURE__*/_react.default.createElement(_portalContext.default.Provider, {
        value: {
    ...
    value: function render() {
      ...
      var svgProps = (0, _assign2.default)(_objectSpread({
        width: width,
        height: height,
        tabIndex: tabIndex,
        role: role,
...
_defineProperty(VictoryContainer, "defaultProps", {
  ...
  portalComponent: /*#__PURE__*/_react.default.createElement(_portal.default, null),
  portalZIndex: 99,
  responsive: true,
  role: "img"
});

_defineProperty(VictoryContainer, "contextType", _timerContext.default);