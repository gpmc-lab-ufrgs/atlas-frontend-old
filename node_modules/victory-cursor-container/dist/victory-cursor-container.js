...
var cursorContainerMixin = function (base) {
    ...
    _createClass(VictoryCursorContainer, [{
      ...
      value: function getCursorElements(props) {
        ...
        if (cursorLabel) {
          ...
          newElements.push( /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_4___default().cloneElement(cursorLabelComponent, lodash_defaults__WEBPACK_IMPORTED_MODULE_2___default()({}, labelProps, {
        ...
        if (cursorDimension === "x" || cursorDimension === undefined) {
          newElements.push( /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_4___default().cloneElement(cursorComponent, {
      ...
      value: function getChildren(props) {
        return [].concat(_toConsumableArray(react__WEBPACK_IMPORTED_MODULE_4___default().Children.toArray(props.children)), _toConsumableArray(this.getCursorElements(props)));
      }
    }]);

    return VictoryCursorContainer;
  }(base), _defineProperty(_class, "displayName", "VictoryCursorContainer"), _defineProperty(_class, "propTypes", _objectSpread(_objectSpread({}, victory_core__WEBPACK_IMPORTED_MODULE_7__["default"].propTypes), {}, {
  ...
  })), _defineProperty(_class, "defaultProps", _objectSpread(_objectSpread({}, victory_core__WEBPACK_IMPORTED_MODULE_7__["default"].defaultProps), {}, {
    cursorLabelComponent: /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_4___default().createElement(victory_core__WEBPACK_IMPORTED_MODULE_8__["default"], null),
    cursorLabelOffset: {
      x: 5,
      y: -10
    },
    cursorComponent: /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_4___default().createElement(victory_core__WEBPACK_IMPORTED_MODULE_9__["default"], null)
