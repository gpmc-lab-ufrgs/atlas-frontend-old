...
var VictoryAxis = /*#__PURE__*/function (_React$Component) {
  ...
  _createClass(VictoryAxis, [{
    ...
    value: function renderLine(props) {
      ...
      return /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_3___default().cloneElement(axisComponent, axisProps);
    }
  }, {
    key: "renderLabel",
    value: function renderLabel(props) {
      ...
      return /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_3___default().cloneElement(axisLabelComponent, axisLabelProps);
    }
  }, {
    ...
    value: function renderGridAndTicks(props) {
      ...
      return this.dataKeys.map(function (key, index) {
        ...
        var BaseTickComponent = /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_3___default().cloneElement(tickComponent, tickProps);
        ...
        var BaseGridComponent = /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_3___default().cloneElement(gridComponent, gridProps);
        ...
        var TickLabel = /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_3___default().cloneElement(tickLabelComponent, tickLabelProps);
        var children = [GridComponent, TickComponent, TickLabel].filter(Boolean);
        return /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_3___default().cloneElement(props.groupComponent, {
    ...
    value: function fixLabelOverlap(gridAndTicks, props) {
      var isVertical = victory_core__WEBPACK_IMPORTED_MODULE_4__.isVertical(props);
      ...
      var labelsSumSize = labels.reduce(function (sum, label) {
        ...
        var labelSize = victory_core__WEBPACK_IMPORTED_MODULE_5__.approximateTextSize(label.text, {
          angle: label.angle,
    ...
    value: function render() {
      ...
      var props = victory_core__WEBPACK_IMPORTED_MODULE_4__.modifyProps(this.props, fallbackProps);
      ...
      return props.standalone ? this.renderContainer(props.containerComponent, children) : /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_3___default().cloneElement(props.groupComponent, {}, children);
    }
  }]);
...
_defineProperty(VictoryAxis, "propTypes", _objectSpread(_objectSpread({}, victory_core__WEBPACK_IMPORTED_MODULE_6__.baseProps), {}, {
  axisComponent: (prop_types__WEBPACK_IMPORTED_MODULE_2___default().element),
  axisLabelComponent: (prop_types__WEBPACK_IMPORTED_MODULE_2___default().element),
  axisValue: prop_types__WEBPACK_IMPORTED_MODULE_2___default().oneOfType([(prop_types__WEBPACK_IMPORTED_MODULE_2___default().number), (prop_types__WEBPACK_IMPORTED_MODULE_2___default().string), (prop_types__WEBPACK_IMPORTED_MODULE_2___default().object)]),
  categories: prop_types__WEBPACK_IMPORTED_MODULE_2___default().oneOfType([prop_types__WEBPACK_IMPORTED_MODULE_2___default().arrayOf((prop_types__WEBPACK_IMPORTED_MODULE_2___default().string)), prop_types__WEBPACK_IMPORTED_MODULE_2___default().shape({
    x: prop_types__WEBPACK_IMPORTED_MODULE_2___default().arrayOf((prop_types__WEBPACK_IMPORTED_MODULE_2___default().string)),
    y: prop_types__WEBPACK_IMPORTED_MODULE_2___default().arrayOf((prop_types__WEBPACK_IMPORTED_MODULE_2___default().string))
  })]),
  crossAxis: (prop_types__WEBPACK_IMPORTED_MODULE_2___default().bool),
  dependentAxis: (prop_types__WEBPACK_IMPORTED_MODULE_2___default().bool),
  events: prop_types__WEBPACK_IMPORTED_MODULE_2___default().arrayOf(prop_types__WEBPACK_IMPORTED_MODULE_2___default().shape({
    target: prop_types__WEBPACK_IMPORTED_MODULE_2___default().oneOf(["axis", "axisLabel", "grid", "ticks", "tickLabels"]),
    eventKey: prop_types__WEBPACK_IMPORTED_MODULE_2___default().oneOfType([(prop_types__WEBPACK_IMPORTED_MODULE_2___default().array), victory_core__WEBPACK_IMPORTED_MODULE_7__.allOfType([victory_core__WEBPACK_IMPORTED_MODULE_7__.integer, victory_core__WEBPACK_IMPORTED_MODULE_7__.nonNegative]), (prop_types__WEBPACK_IMPORTED_MODULE_2___default().string)]),
    eventHandlers: (prop_types__WEBPACK_IMPORTED_MODULE_2___default().object)
  })),
  fixLabelOverlap: (prop_types__WEBPACK_IMPORTED_MODULE_2___default().bool),
  gridComponent: (prop_types__WEBPACK_IMPORTED_MODULE_2___default().element),
  groupComponent: (prop_types__WEBPACK_IMPORTED_MODULE_2___default().element),
  invertAxis: (prop_types__WEBPACK_IMPORTED_MODULE_2___default().bool),
  ...
  orientation: prop_types__WEBPACK_IMPORTED_MODULE_2___default().oneOf(["top", "bottom", "left", "right"]),
  origin: prop_types__WEBPACK_IMPORTED_MODULE_2___default().shape({
    x: (prop_types__WEBPACK_IMPORTED_MODULE_2___default().number),
    y: (prop_types__WEBPACK_IMPORTED_MODULE_2___default().number)
  }),
  stringMap: (prop_types__WEBPACK_IMPORTED_MODULE_2___default().object),
  style: prop_types__WEBPACK_IMPORTED_MODULE_2___default().shape({
    parent: (prop_types__WEBPACK_IMPORTED_MODULE_2___default().object),
    axis: (prop_types__WEBPACK_IMPORTED_MODULE_2___default().object),
    axisLabel: (prop_types__WEBPACK_IMPORTED_MODULE_2___default().object),
    grid: (prop_types__WEBPACK_IMPORTED_MODULE_2___default().object),
    ticks: (prop_types__WEBPACK_IMPORTED_MODULE_2___default().object),
    tickLabels: (prop_types__WEBPACK_IMPORTED_MODULE_2___default().object)
  }),
  tickComponent: (prop_types__WEBPACK_IMPORTED_MODULE_2___default().element),
  ...
  tickFormat: prop_types__WEBPACK_IMPORTED_MODULE_2___default().oneOfType([(prop_types__WEBPACK_IMPORTED_MODULE_2___default().func), victory_core__WEBPACK_IMPORTED_MODULE_7__.homogeneousArray]),
  tickLabelComponent: (prop_types__WEBPACK_IMPORTED_MODULE_2___default().element),
  tickValues: victory_core__WEBPACK_IMPORTED_MODULE_7__.homogeneousArray
}));

_defineProperty(VictoryAxis, "defaultProps", {
  axisComponent: /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_3___default().createElement(victory_core__WEBPACK_IMPORTED_MODULE_8__["default"], null),
  axisLabelComponent: /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_3___default().createElement(victory_core__WEBPACK_IMPORTED_MODULE_9__["default"], null),
  tickLabelComponent: /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_3___default().createElement(victory_core__WEBPACK_IMPORTED_MODULE_9__["default"], null),
  tickComponent: /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_3___default().createElement(victory_core__WEBPACK_IMPORTED_MODULE_8__["default"], null),
  gridComponent: /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_3___default().createElement(victory_core__WEBPACK_IMPORTED_MODULE_8__["default"], null),
  standalone: true,
  theme: victory_core__WEBPACK_IMPORTED_MODULE_10__["default"].grayscale,
  containerComponent: /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_3___default().createElement(victory_core__WEBPACK_IMPORTED_MODULE_11__["default"], null),
...
_defineProperty(VictoryAxis, "getDomain", victory_core__WEBPACK_IMPORTED_MODULE_4__.getDomain);

_defineProperty(VictoryAxis, "getAxis", victory_core__WEBPACK_IMPORTED_MODULE_4__.getAxis);
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ((0,victory_core__WEBPACK_IMPORTED_MODULE_13__["default"])(VictoryAxis, options));
...
LineSegment.propTypes = _objectSpread(_objectSpread({}, _victory_util_common_props__WEBPACK_IMPORTED_MODULE_4__.primitiveProps), {}, {
