  ...
  return _class = /*#__PURE__*/function (_base) {
    ...
    _createClass(VictoryBrushContainer, [{
      ...
      value: function getSelectBox(props, coordinates) {
        ...
        return x[0] !== x[1] && y[0] !== y[1] ? /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_3___default().cloneElement(brushComponent, {
      ...
      value: function getHandles(props, domain) {
        ...
        var handles = ["top", "bottom", "left", "right"].reduce(function (memo, curr) {
          memo = handleProps[curr] ? memo.concat( /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_3___default().cloneElement(handleComponent, lodash_assign__WEBPACK_IMPORTED_MODULE_1___default()({
      ...
      value: function getChildren(props) {
        return [].concat(_toConsumableArray(react__WEBPACK_IMPORTED_MODULE_3___default().Children.toArray(props.children)), _toConsumableArray(this.getRect(props)));
      }
    }]);

    return VictoryBrushContainer;
  }(base), _defineProperty(_class, "displayName", "VictoryBrushContainer"), _defineProperty(_class, "propTypes", _objectSpread(_objectSpread({}, victory_core__WEBPACK_IMPORTED_MODULE_7__["default"].propTypes), {}, {
    ...
    allowDraw: true,
    allowResize: true,
    brushComponent: /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_3___default().createElement(victory_core__WEBPACK_IMPORTED_MODULE_8__["default"], null),
    brushStyle: {
      stroke: "transparent",
      fill: "black",
      fillOpacity: 0.1
    },
    handleComponent: /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_3___default().createElement(victory_core__WEBPACK_IMPORTED_MODULE_8__["default"], null),
    handleStyle: {
      stroke: "transparent",
      fill: "transparent"
    },
