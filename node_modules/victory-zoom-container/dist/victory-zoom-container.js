...
/* harmony import */ var _zoom_helpers__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./zoom-helpers */ "./zoom-helpers.js");
...
var zoomContainerMixin = function (base) {
  ...
  return _class = /*#__PURE__*/function (_base) {
    ...
    _createClass(VictoryZoomContainer, [{
      ...
      value: function clipDataComponents(children, props) {
        ...
        var groupComponent = /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_3___default().cloneElement(clipContainerComponent, _objectSpread({
        ...
        return react__WEBPACK_IMPORTED_MODULE_3___default().Children.toArray(children).map(function (child) {
          if (!victory_core__WEBPACK_IMPORTED_MODULE_4__.isDataComponent(child)) {
            return child;
          } else {
            return /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_3___default().cloneElement(child, {
      ...
      value: function downsampleZoomData(props, child, domain) {
        ...
        return victory_core__WEBPACK_IMPORTED_MODULE_4__.downsample(visibleData, maxPoints, startIndex);
      }
    }, {
      key: "modifyChildren",
      value: function modifyChildren(props) {
        ...
        var childComponents = react__WEBPACK_IMPORTED_MODULE_3___default().Children.toArray(props.children); // eslint-disable-next-line max-statements

        return childComponents.map(function (child) {
          var role = child.type && child.type.role;
          var isDataComponent = victory_core__WEBPACK_IMPORTED_MODULE_4__.isDataComponent(child);
          ...
          if (!_zoom_helpers__WEBPACK_IMPORTED_MODULE_5__["default"].checkDomainEquality(zoomDomain, cachedZoomDomain)) {
          ...
          return /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_3___default().cloneElement(child, lodash_defaults__WEBPACK_IMPORTED_MODULE_1___default()(newProps, child.props));
        });
  ...
  }(base), _defineProperty(_class, "displayName", "VictoryZoomContainer"), _defineProperty(_class, "propTypes", _objectSpread(_objectSpread({}, victory_core__WEBPACK_IMPORTED_MODULE_6__["default"].propTypes), {}, {
    allowPan: (prop_types__WEBPACK_IMPORTED_MODULE_2___default().bool),
    allowZoom: (prop_types__WEBPACK_IMPORTED_MODULE_2___default().bool),
    clipContainerComponent: (prop_types__WEBPACK_IMPORTED_MODULE_2___default().element.isRequired),
    disable: (prop_types__WEBPACK_IMPORTED_MODULE_2___default().bool),
    downsample: prop_types__WEBPACK_IMPORTED_MODULE_2___default().oneOfType([(prop_types__WEBPACK_IMPORTED_MODULE_2___default().bool), (prop_types__WEBPACK_IMPORTED_MODULE_2___default().number)]),
    minimumZoom: prop_types__WEBPACK_IMPORTED_MODULE_2___default().shape({
      x: (prop_types__WEBPACK_IMPORTED_MODULE_2___default().number),
      y: (prop_types__WEBPACK_IMPORTED_MODULE_2___default().number)
    }),
    onZoomDomainChange: (prop_types__WEBPACK_IMPORTED_MODULE_2___default().func),
    zoomDimension: prop_types__WEBPACK_IMPORTED_MODULE_2___default().oneOf(["x", "y"]),
    zoomDomain: prop_types__WEBPACK_IMPORTED_MODULE_2___default().shape({
    ...
    clipContainerComponent: /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_3___default().createElement(victory_core__WEBPACK_IMPORTED_MODULE_8__["default"], null),
    allowPan: true,
    allowZoom: true,
    zoomActive: false
    ...
    return [{
      ...
      eventHandlers: _objectSpread({
        onMouseDown: function (evt, targetProps) {
          return props.disable ? {} : _zoom_helpers__WEBPACK_IMPORTED_MODULE_5__["default"].onMouseDown(evt, targetProps);
        },
        onTouchStart: function (evt, targetProps) {
          return props.disable ? {} : _zoom_helpers__WEBPACK_IMPORTED_MODULE_5__["default"].onMouseDown(evt, targetProps);
        },
        onMouseUp: function (evt, targetProps) {
          return props.disable ? {} : _zoom_helpers__WEBPACK_IMPORTED_MODULE_5__["default"].onMouseUp(evt, targetProps);
        },
        onTouchEnd: function (evt, targetProps) {
          return props.disable ? {} : _zoom_helpers__WEBPACK_IMPORTED_MODULE_5__["default"].onMouseUp(evt, targetProps);
        },
        onMouseLeave: function (evt, targetProps) {
          return props.disable ? {} : _zoom_helpers__WEBPACK_IMPORTED_MODULE_5__["default"].onMouseLeave(evt, targetProps);
        },
        ...
        onMouseMove: function (evt, targetProps, eventKey, ctx) {
          ...
          return _zoom_helpers__WEBPACK_IMPORTED_MODULE_5__["default"].onMouseMove(evt, targetProps, eventKey, ctx);
        },
        // eslint-disable-next-line max-params
        ...
        onWheel: _zoom_helpers__WEBPACK_IMPORTED_MODULE_5__["default"].onWheel
      })
    }];
  }), _class;
};
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (zoomContainerMixin(victory_core__WEBPACK_IMPORTED_MODULE_6__["default"]));
...
var VictoryClipContainer = /*#__PURE__*/function (_React$Component) {
  ...
  _createClass(VictoryClipContainer, [{
    ...
    value: function calculateAttributes(props) {
      ...
      var clipPadding = _victory_util_helpers__WEBPACK_IMPORTED_MODULE_6__.getPadding({
        padding: props.clipPadding
      });
      var radius = props.radius || _victory_util_helpers__WEBPACK_IMPORTED_MODULE_6__.getRadius(props);
      return {
    ...
    value: function renderClippedGroup(props, clipId) {
      ...
      return /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_4___default().cloneElement(groupComponent, _objectSpread(_objectSpread({}, groupProps), {}, {
        ...
        tabIndex: tabIndex
      }), [clipComponent].concat(_toConsumableArray(react__WEBPACK_IMPORTED_MODULE_4___default().Children.toArray(children))));
    }
  }, {
    key: "renderGroup",
    ...
    value: function renderClipComponent(props, clipId) {
      ...
      var _Helpers$getPadding = _victory_util_helpers__WEBPACK_IMPORTED_MODULE_6__.getPadding({
        padding: props.clipPadding
      }),
    ...
    value: function getClipValue(props, axis) {
      ...
      var range = _victory_util_helpers__WEBPACK_IMPORTED_MODULE_6__.getRange(props, axis);
...
_defineProperty(VictoryClipContainer, "propTypes", {
  ...
  clipPadding: prop_types__WEBPACK_IMPORTED_MODULE_5___default().shape({
    top: (prop_types__WEBPACK_IMPORTED_MODULE_5___default().number),
    bottom: (prop_types__WEBPACK_IMPORTED_MODULE_5___default().number),
    left: (prop_types__WEBPACK_IMPORTED_MODULE_5___default().number),
    right: (prop_types__WEBPACK_IMPORTED_MODULE_5___default().number)
  }),
  ...
  events: (prop_types__WEBPACK_IMPORTED_MODULE_5___default().object),
  groupComponent: (prop_types__WEBPACK_IMPORTED_MODULE_5___default().element),
  origin: prop_types__WEBPACK_IMPORTED_MODULE_5___default().shape({
  ...
  polar: (prop_types__WEBPACK_IMPORTED_MODULE_5___default().bool),
  ...
  transform: (prop_types__WEBPACK_IMPORTED_MODULE_5___default().string),
  translateX: (prop_types__WEBPACK_IMPORTED_MODULE_5___default().number),
  translateY: (prop_types__WEBPACK_IMPORTED_MODULE_5___default().number)
});

_defineProperty(VictoryClipContainer, "defaultProps", {
  circleComponent: /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_4___default().createElement(_victory_primitives_circle__WEBPACK_IMPORTED_MODULE_8__["default"], null),
  rectComponent: /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_4___default().createElement(_victory_primitives_rect__WEBPACK_IMPORTED_MODULE_9__["default"], null),
  clipPathComponent: /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_4___default().createElement(_victory_primitives_clip_path__WEBPACK_IMPORTED_MODULE_10__["default"], null),
