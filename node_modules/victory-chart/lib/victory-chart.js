...
var VictoryChart = function (initialProps) {
  ...
  var containerProps = _react.default.useMemo(function () {
    ...
    return {};
  }, [desc, domain, height, horizontal, name, origin, polar, radius, scale, standalone, style, title, theme, width]);
...
VictoryChart.propTypes = _objectSpread(_objectSpread({}, _victoryCore.CommonProps.baseProps), {}, {
...
var VictoryChartMemo = /*#__PURE__*/_react.default.memo(VictoryChart, _reactFastCompare.default);
