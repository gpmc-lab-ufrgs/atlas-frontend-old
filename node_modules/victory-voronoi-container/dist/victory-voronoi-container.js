  ...
  return _class = /*#__PURE__*/function (_base) {
    ...
    _createClass(VictoryVoronoiContainer, [{
      ...
      value: function getLabelPosition(props, labelProps, points) {
        ...
        var basePosition = victory_core__WEBPACK_IMPORTED_MODULE_5__.scalePoint(props, point);
      ...
      value: function getStyle(props, points, type) {
        ...
        return points.reduce(function (memo, datum, index) {
          ...
          var style = victory_core__WEBPACK_IMPORTED_MODULE_5__.evaluateStyle(lodash_defaults__WEBPACK_IMPORTED_MODULE_2___default()({}, componentStyle, baseStyle, themeStyles[type]), labelProps);
      ...
      value: function getTooltip(props) {
        ...
        if (Array.isArray(activePoints) && activePoints.length) {
          ...
          return showLabel ? /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_4___default().cloneElement(labelComponent, labelProps) : null;
        } else {
          return null;
        }
      ...
      value: function getChildren(props) {
        return [].concat(_toConsumableArray(react__WEBPACK_IMPORTED_MODULE_4___default().Children.toArray(props.children)), [this.getTooltip(props)]);
      }
    }]);

    return VictoryVoronoiContainer;
  }(base), _defineProperty(_class, "displayName", "VictoryVoronoiContainer"), _defineProperty(_class, "propTypes", _objectSpread(_objectSpread({}, victory_core__WEBPACK_IMPORTED_MODULE_6__["default"].propTypes), {}, {
    activateData: (prop_types__WEBPACK_IMPORTED_MODULE_3___default().bool),
    activateLabels: (prop_types__WEBPACK_IMPORTED_MODULE_3___default().bool),
    ...
    labels: (prop_types__WEBPACK_IMPORTED_MODULE_3___default().func),
    mouseFollowTooltips: (prop_types__WEBPACK_IMPORTED_MODULE_3___default().bool),
    onActivated: (prop_types__WEBPACK_IMPORTED_MODULE_3___default().func),
    onDeactivated: (prop_types__WEBPACK_IMPORTED_MODULE_3___default().func),
    radius: (prop_types__WEBPACK_IMPORTED_MODULE_3___default().number),
    voronoiBlacklist: prop_types__WEBPACK_IMPORTED_MODULE_3___default().arrayOf(prop_types__WEBPACK_IMPORTED_MODULE_3___default().oneOfType([(prop_types__WEBPACK_IMPORTED_MODULE_3___default().string), victory_core__WEBPACK_IMPORTED_MODULE_7__.regExp])),
    voronoiDimension: prop_types__WEBPACK_IMPORTED_MODULE_3___default().oneOf(["x", "y"]),
    voronoiPadding: prop_types__WEBPACK_IMPORTED_MODULE_3___default().oneOfType([(prop_types__WEBPACK_IMPORTED_MODULE_3___default().number), prop_types__WEBPACK_IMPORTED_MODULE_3___default().shape({
    ...
    activateData: true,
    activateLabels: true,
    labelComponent: /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_4___default().createElement(victory_tooltip__WEBPACK_IMPORTED_MODULE_8__["default"], null),
    voronoiPadding: 5
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (voronoiContainerMixin(victory_core__WEBPACK_IMPORTED_MODULE_6__["default"]));
...
/* harmony import */ var _victory_util_user_props__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ../victory-util/user-props */ "../../victory-core/es/victory-util/user-props.js");
...
var VictoryContainer = /*#__PURE__*/function (_React$Component) {
  ...
  _createClass(VictoryContainer, [{
    ...
    value: function renderContainer(props, svgProps, style) {
      ...
      return /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_5___default().createElement(_victory_portal_portal_context__WEBPACK_IMPORTED_MODULE_7__["default"].Provider, {
        value: {
    ...
    value: function render() {
      ...
      var userProps = _victory_util_user_props__WEBPACK_IMPORTED_MODULE_9__.getSafeUserProps(this.props);
...
var getFullBackground = function (calculatedProps, tspanValues) {
  ...
  return /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_4___default().cloneElement(backgroundComponent, lodash_defaults__WEBPACK_IMPORTED_MODULE_1___default()({}, backgroundComponent.props, backgroundProps));
};
...
var renderLabel = function (calculatedProps, tspanValues) {
  ...
  var tspans = text.map(function (line, i) {
    ...
    return /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_4___default().cloneElement(tspanComponent, tspanProps);
  });
  return /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_4___default().cloneElement(textComponent, textProps, tspans);
};
...
var VictoryLabel = function (props) {
  ...
  if (props.backgroundStyle) {
    ...
    var backgroundWithLabel = /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_4___default().cloneElement(props.groupComponent, {}, children);
    return props.renderInPortal ? /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_4___default().createElement(_victory_portal_victory_portal__WEBPACK_IMPORTED_MODULE_10__["default"], null, backgroundWithLabel) : backgroundWithLabel;
  }

  return props.renderInPortal ? /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_4___default().createElement(_victory_portal_victory_portal__WEBPACK_IMPORTED_MODULE_10__["default"], null, label) : label;
};
...
VictoryLabel.propTypes = {
  ...
  angle: prop_types__WEBPACK_IMPORTED_MODULE_3___default().oneOfType([(prop_types__WEBPACK_IMPORTED_MODULE_3___default().string), (prop_types__WEBPACK_IMPORTED_MODULE_3___default().number), (prop_types__WEBPACK_IMPORTED_MODULE_3___default().func)]),
  ariaLabel: prop_types__WEBPACK_IMPORTED_MODULE_3___default().oneOfType([(prop_types__WEBPACK_IMPORTED_MODULE_3___default().string), (prop_types__WEBPACK_IMPORTED_MODULE_3___default().func)]),
  backgroundComponent: (prop_types__WEBPACK_IMPORTED_MODULE_3___default().element),
  backgroundPadding: prop_types__WEBPACK_IMPORTED_MODULE_3___default().oneOfType([(prop_types__WEBPACK_IMPORTED_MODULE_3___default().number), (prop_types__WEBPACK_IMPORTED_MODULE_3___default().object), (prop_types__WEBPACK_IMPORTED_MODULE_3___default().array)]),
  backgroundStyle: prop_types__WEBPACK_IMPORTED_MODULE_3___default().oneOfType([(prop_types__WEBPACK_IMPORTED_MODULE_3___default().object), (prop_types__WEBPACK_IMPORTED_MODULE_3___default().array)]),
  capHeight: prop_types__WEBPACK_IMPORTED_MODULE_3___default().oneOfType([(prop_types__WEBPACK_IMPORTED_MODULE_3___default().string), _victory_util_prop_types__WEBPACK_IMPORTED_MODULE_11__.nonNegative, (prop_types__WEBPACK_IMPORTED_MODULE_3___default().func)]),
  className: (prop_types__WEBPACK_IMPORTED_MODULE_3___default().string),
  data: (prop_types__WEBPACK_IMPORTED_MODULE_3___default().array),
  datum: (prop_types__WEBPACK_IMPORTED_MODULE_3___default().any),
  desc: prop_types__WEBPACK_IMPORTED_MODULE_3___default().oneOfType([(prop_types__WEBPACK_IMPORTED_MODULE_3___default().string), (prop_types__WEBPACK_IMPORTED_MODULE_3___default().func)]),
  direction: prop_types__WEBPACK_IMPORTED_MODULE_3___default().oneOf(["rtl", "ltr", "inherit"]),
  dx: prop_types__WEBPACK_IMPORTED_MODULE_3___default().oneOfType([(prop_types__WEBPACK_IMPORTED_MODULE_3___default().number), (prop_types__WEBPACK_IMPORTED_MODULE_3___default().string), (prop_types__WEBPACK_IMPORTED_MODULE_3___default().func)]),
  dy: prop_types__WEBPACK_IMPORTED_MODULE_3___default().oneOfType([(prop_types__WEBPACK_IMPORTED_MODULE_3___default().number), (prop_types__WEBPACK_IMPORTED_MODULE_3___default().string), (prop_types__WEBPACK_IMPORTED_MODULE_3___default().func)]),
  events: (prop_types__WEBPACK_IMPORTED_MODULE_3___default().object),
  groupComponent: (prop_types__WEBPACK_IMPORTED_MODULE_3___default().element),
  id: prop_types__WEBPACK_IMPORTED_MODULE_3___default().oneOfType([(prop_types__WEBPACK_IMPORTED_MODULE_3___default().number), (prop_types__WEBPACK_IMPORTED_MODULE_3___default().string), (prop_types__WEBPACK_IMPORTED_MODULE_3___default().func)]),
  index: prop_types__WEBPACK_IMPORTED_MODULE_3___default().oneOfType([(prop_types__WEBPACK_IMPORTED_MODULE_3___default().number), (prop_types__WEBPACK_IMPORTED_MODULE_3___default().string)]),
  inline: (prop_types__WEBPACK_IMPORTED_MODULE_3___default().bool),
  labelPlacement: prop_types__WEBPACK_IMPORTED_MODULE_3___default().oneOf(["parallel", "perpendicular", "vertical"]),
  lineHeight: prop_types__WEBPACK_IMPORTED_MODULE_3___default().oneOfType([(prop_types__WEBPACK_IMPORTED_MODULE_3___default().string), _victory_util_prop_types__WEBPACK_IMPORTED_MODULE_11__.nonNegative, (prop_types__WEBPACK_IMPORTED_MODULE_3___default().func), (prop_types__WEBPACK_IMPORTED_MODULE_3___default().array)]),
  ...
  polar: (prop_types__WEBPACK_IMPORTED_MODULE_3___default().bool),
  renderInPortal: (prop_types__WEBPACK_IMPORTED_MODULE_3___default().bool),
  scale: prop_types__WEBPACK_IMPORTED_MODULE_3___default().shape({
  ...
  tabIndex: prop_types__WEBPACK_IMPORTED_MODULE_3___default().oneOfType([(prop_types__WEBPACK_IMPORTED_MODULE_3___default().number), (prop_types__WEBPACK_IMPORTED_MODULE_3___default().func)]),
  text: prop_types__WEBPACK_IMPORTED_MODULE_3___default().oneOfType([(prop_types__WEBPACK_IMPORTED_MODULE_3___default().string), (prop_types__WEBPACK_IMPORTED_MODULE_3___default().number), (prop_types__WEBPACK_IMPORTED_MODULE_3___default().func), (prop_types__WEBPACK_IMPORTED_MODULE_3___default().array)]),
  textAnchor: prop_types__WEBPACK_IMPORTED_MODULE_3___default().oneOfType([prop_types__WEBPACK_IMPORTED_MODULE_3___default().oneOf(["start", "middle", "end", "inherit"]), (prop_types__WEBPACK_IMPORTED_MODULE_3___default().func)]),
  textComponent: (prop_types__WEBPACK_IMPORTED_MODULE_3___default().element),
  title: (prop_types__WEBPACK_IMPORTED_MODULE_3___default().string),
  transform: prop_types__WEBPACK_IMPORTED_MODULE_3___default().oneOfType([(prop_types__WEBPACK_IMPORTED_MODULE_3___default().string), (prop_types__WEBPACK_IMPORTED_MODULE_3___default().object), (prop_types__WEBPACK_IMPORTED_MODULE_3___default().func)]),
  tspanComponent: (prop_types__WEBPACK_IMPORTED_MODULE_3___default().element),
  verticalAnchor: prop_types__WEBPACK_IMPORTED_MODULE_3___default().oneOfType([prop_types__WEBPACK_IMPORTED_MODULE_3___default().oneOf(["start", "middle", "end"]), (prop_types__WEBPACK_IMPORTED_MODULE_3___default().func)]),
  x: prop_types__WEBPACK_IMPORTED_MODULE_3___default().oneOfType([(prop_types__WEBPACK_IMPORTED_MODULE_3___default().number), (prop_types__WEBPACK_IMPORTED_MODULE_3___default().string)]),
  y: prop_types__WEBPACK_IMPORTED_MODULE_3___default().oneOfType([(prop_types__WEBPACK_IMPORTED_MODULE_3___default().number), (prop_types__WEBPACK_IMPORTED_MODULE_3___default().string)])
};
VictoryLabel.defaultProps = {
  backgroundComponent: /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_4___default().createElement(_victory_primitives_rect__WEBPACK_IMPORTED_MODULE_12__["default"], null),
  groupComponent: /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_4___default().createElement("g", null),
  direction: "inherit",
  textComponent: /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_4___default().createElement(_victory_primitives_text__WEBPACK_IMPORTED_MODULE_13__["default"], null),
  tspanComponent: /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_4___default().createElement(_victory_primitives_tspan__WEBPACK_IMPORTED_MODULE_14__["default"], null),
  capHeight: 0.71,
...
var Flyout = function (props) {
  props = evaluateProps(props);
  return /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_2___default().cloneElement(props.pathComponent, _objectSpread(_objectSpread({}, props.events), {}, {
    style: props.style,
...
Flyout.propTypes = _objectSpread(_objectSpread({}, victory_core__WEBPACK_IMPORTED_MODULE_5__.primitiveProps), {}, {
  center: prop_types__WEBPACK_IMPORTED_MODULE_3___default().shape({
    x: (prop_types__WEBPACK_IMPORTED_MODULE_3___default().number),
    y: (prop_types__WEBPACK_IMPORTED_MODULE_3___default().number)
  }),
  cornerRadius: (prop_types__WEBPACK_IMPORTED_MODULE_3___default().number),
  datum: (prop_types__WEBPACK_IMPORTED_MODULE_3___default().object),
  dx: (prop_types__WEBPACK_IMPORTED_MODULE_3___default().number),
  dy: (prop_types__WEBPACK_IMPORTED_MODULE_3___default().number),
  height: (prop_types__WEBPACK_IMPORTED_MODULE_3___default().number),
  orientation: prop_types__WEBPACK_IMPORTED_MODULE_3___default().oneOf(["top", "bottom", "left", "right"]),
  pathComponent: (prop_types__WEBPACK_IMPORTED_MODULE_3___default().element),
  pointerLength: (prop_types__WEBPACK_IMPORTED_MODULE_3___default().number),
  pointerWidth: (prop_types__WEBPACK_IMPORTED_MODULE_3___default().number),
  width: (prop_types__WEBPACK_IMPORTED_MODULE_3___default().number),
  x: (prop_types__WEBPACK_IMPORTED_MODULE_3___default().number),
  y: (prop_types__WEBPACK_IMPORTED_MODULE_3___default().number)
});
Flyout.defaultProps = {
  pathComponent: /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_2___default().createElement(victory_core__WEBPACK_IMPORTED_MODULE_6__["default"], null),
  role: "presentation",
  shapeRendering: "auto"
};
...
var VictoryTooltip = /*#__PURE__*/function (_React$Component) {
  ...
  _createClass(VictoryTooltip, [{
    ...
    value: function getPolarOrientation(props, datum) {
      var degrees = victory_core__WEBPACK_IMPORTED_MODULE_7__.getDegrees(props, datum);
    ...
    value: function getStyles(props) {
      var theme = props.theme || victory_core__WEBPACK_IMPORTED_MODULE_8__["default"].grayscale;
      ...
      var style = Array.isArray(baseLabelStyle) ? baseLabelStyle.map(function (s) {
        return victory_core__WEBPACK_IMPORTED_MODULE_9__.evaluateStyle(s, props);
      }) : victory_core__WEBPACK_IMPORTED_MODULE_9__.evaluateStyle(baseLabelStyle, props);
      var flyoutStyle = victory_core__WEBPACK_IMPORTED_MODULE_9__.evaluateStyle(baseFlyoutStyle, lodash_assign__WEBPACK_IMPORTED_MODULE_4___default()({}, props, {
        style: style
      }));
      return {
        style: style,
    ...
    value: function getEvaluatedProps(props) {
      var cornerRadius = props.cornerRadius,
          ...
          dx = props.dx,
          dy = props.dy;
      var active = victory_core__WEBPACK_IMPORTED_MODULE_9__.evaluateProp(props.active, props);
      var text = victory_core__WEBPACK_IMPORTED_MODULE_9__.evaluateProp(props.text, lodash_assign__WEBPACK_IMPORTED_MODULE_4___default()({}, props, {
        active: active
      }));
      ...
      var orientation = victory_core__WEBPACK_IMPORTED_MODULE_9__.evaluateProp(props.orientation, lodash_assign__WEBPACK_IMPORTED_MODULE_4___default()({}, props, {
        active: active,
        text: text,
        style: style,
        flyoutStyle: flyoutStyle
      })) || this.getDefaultOrientation(props);
      var padding = victory_core__WEBPACK_IMPORTED_MODULE_9__.evaluateProp(props.flyoutPadding, lodash_assign__WEBPACK_IMPORTED_MODULE_4___default()({}, props, {
        active: active,
        text: text,
        style: style,
        flyoutStyle: flyoutStyle,
      ...
      var flyoutPadding = victory_core__WEBPACK_IMPORTED_MODULE_9__.getPadding({
        padding: padding
      });
      var pointerWidth = victory_core__WEBPACK_IMPORTED_MODULE_9__.evaluateProp(props.pointerWidth, lodash_assign__WEBPACK_IMPORTED_MODULE_4___default()({}, props, {
        active: active,
        text: text,
        style: style,
        flyoutStyle: flyoutStyle,
      ...
      var pointerLength = victory_core__WEBPACK_IMPORTED_MODULE_9__.evaluateProp(props.pointerLength, lodash_assign__WEBPACK_IMPORTED_MODULE_4___default()({}, props, {
        active: active,
        text: text,
        style: style,
        flyoutStyle: flyoutStyle,
      ...
      var labelSize = victory_core__WEBPACK_IMPORTED_MODULE_10__.approximateTextSize(text, style);
      ...
      var offsetX = lodash_isPlainObject__WEBPACK_IMPORTED_MODULE_1___default()(centerOffset) && centerOffset.x !== undefined ? victory_core__WEBPACK_IMPORTED_MODULE_9__.evaluateProp(centerOffset.x, evaluatedProps) : 0;
      var offsetY = lodash_isPlainObject__WEBPACK_IMPORTED_MODULE_1___default()(centerOffset) && centerOffset.y !== undefined ? victory_core__WEBPACK_IMPORTED_MODULE_9__.evaluateProp(centerOffset.y, evaluatedProps) : 0;
    ...
    value: function getDimensions(props, labelSize) {
      ...
      var cornerRadius = victory_core__WEBPACK_IMPORTED_MODULE_9__.evaluateProp(props.cornerRadius, props);
      ...
      return {
        flyoutHeight: flyoutHeight ? victory_core__WEBPACK_IMPORTED_MODULE_9__.evaluateProp(flyoutHeight, props) : getHeight(props, labelSize, orientation),
        flyoutWidth: flyoutWidth ? victory_core__WEBPACK_IMPORTED_MODULE_9__.evaluateProp(flyoutWidth, props) : getWidth(props, labelSize, orientation)
      };
    }
  }, {
    key: "getLabelProps",
    ...
    value: function getFlyoutProps(props, calculatedValues) {
      ...
      var pointerOrientation = victory_core__WEBPACK_IMPORTED_MODULE_9__.evaluateProp(props.pointerOrientation, props);
    ...
    value: function renderTooltip(props) {
      ...
      if (!active) {
        return renderInPortal ? /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_5___default().createElement(victory_core__WEBPACK_IMPORTED_MODULE_11__["default"], null, null) : null;
      }
      ...
      return renderInPortal ? /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_5___default().createElement(victory_core__WEBPACK_IMPORTED_MODULE_11__["default"], null, tooltip) : tooltip;
    }
  }, {
    key: "render",
    value: function render() {
      var props = victory_core__WEBPACK_IMPORTED_MODULE_9__.modifyProps(this.props, fallbackProps, "tooltip");
...
_defineProperty(VictoryTooltip, "propTypes", {
  ...
  active: prop_types__WEBPACK_IMPORTED_MODULE_6___default().oneOfType([(prop_types__WEBPACK_IMPORTED_MODULE_6___default().bool), (prop_types__WEBPACK_IMPORTED_MODULE_6___default().func)]),
  activePoints: (prop_types__WEBPACK_IMPORTED_MODULE_6___default().array),
  angle: (prop_types__WEBPACK_IMPORTED_MODULE_6___default().number),
  ...
  centerOffset: prop_types__WEBPACK_IMPORTED_MODULE_6___default().shape({
    x: prop_types__WEBPACK_IMPORTED_MODULE_6___default().oneOfType([(prop_types__WEBPACK_IMPORTED_MODULE_6___default().number), (prop_types__WEBPACK_IMPORTED_MODULE_6___default().func)]),
    y: prop_types__WEBPACK_IMPORTED_MODULE_6___default().oneOfType([(prop_types__WEBPACK_IMPORTED_MODULE_6___default().number), (prop_types__WEBPACK_IMPORTED_MODULE_6___default().func)])
  }),
  constrainToVisibleArea: (prop_types__WEBPACK_IMPORTED_MODULE_6___default().bool),
  cornerRadius: prop_types__WEBPACK_IMPORTED_MODULE_6___default().oneOfType([victory_core__WEBPACK_IMPORTED_MODULE_12__.nonNegative, (prop_types__WEBPACK_IMPORTED_MODULE_6___default().func)]),
  data: (prop_types__WEBPACK_IMPORTED_MODULE_6___default().array),
  datum: (prop_types__WEBPACK_IMPORTED_MODULE_6___default().object),
  dx: prop_types__WEBPACK_IMPORTED_MODULE_6___default().oneOfType([(prop_types__WEBPACK_IMPORTED_MODULE_6___default().number), (prop_types__WEBPACK_IMPORTED_MODULE_6___default().func)]),
  dy: prop_types__WEBPACK_IMPORTED_MODULE_6___default().oneOfType([(prop_types__WEBPACK_IMPORTED_MODULE_6___default().number), (prop_types__WEBPACK_IMPORTED_MODULE_6___default().func)]),
  events: (prop_types__WEBPACK_IMPORTED_MODULE_6___default().object),
  flyoutComponent: (prop_types__WEBPACK_IMPORTED_MODULE_6___default().element),
  flyoutHeight: prop_types__WEBPACK_IMPORTED_MODULE_6___default().oneOfType([victory_core__WEBPACK_IMPORTED_MODULE_12__.nonNegative, (prop_types__WEBPACK_IMPORTED_MODULE_6___default().func)]),
  flyoutPadding: prop_types__WEBPACK_IMPORTED_MODULE_6___default().oneOfType([(prop_types__WEBPACK_IMPORTED_MODULE_6___default().func), (prop_types__WEBPACK_IMPORTED_MODULE_6___default().number), prop_types__WEBPACK_IMPORTED_MODULE_6___default().shape({
  ...
  flyoutStyle: (prop_types__WEBPACK_IMPORTED_MODULE_6___default().object),
  flyoutWidth: prop_types__WEBPACK_IMPORTED_MODULE_6___default().oneOfType([victory_core__WEBPACK_IMPORTED_MODULE_12__.nonNegative, (prop_types__WEBPACK_IMPORTED_MODULE_6___default().func)]),
  ...
  index: prop_types__WEBPACK_IMPORTED_MODULE_6___default().oneOfType([(prop_types__WEBPACK_IMPORTED_MODULE_6___default().number), (prop_types__WEBPACK_IMPORTED_MODULE_6___default().string)]),
  labelComponent: (prop_types__WEBPACK_IMPORTED_MODULE_6___default().element),
  orientation: prop_types__WEBPACK_IMPORTED_MODULE_6___default().oneOfType([prop_types__WEBPACK_IMPORTED_MODULE_6___default().oneOf(["top", "bottom", "left", "right"]), (prop_types__WEBPACK_IMPORTED_MODULE_6___default().func)]),
  pointerLength: prop_types__WEBPACK_IMPORTED_MODULE_6___default().oneOfType([victory_core__WEBPACK_IMPORTED_MODULE_12__.nonNegative, (prop_types__WEBPACK_IMPORTED_MODULE_6___default().func)]),
  pointerOrientation: prop_types__WEBPACK_IMPORTED_MODULE_6___default().oneOfType([prop_types__WEBPACK_IMPORTED_MODULE_6___default().oneOf(["top", "bottom", "left", "right"]), (prop_types__WEBPACK_IMPORTED_MODULE_6___default().func)]),
  pointerWidth: prop_types__WEBPACK_IMPORTED_MODULE_6___default().oneOfType([victory_core__WEBPACK_IMPORTED_MODULE_12__.nonNegative, (prop_types__WEBPACK_IMPORTED_MODULE_6___default().func)]),
  polar: (prop_types__WEBPACK_IMPORTED_MODULE_6___default().bool),
  renderInPortal: (prop_types__WEBPACK_IMPORTED_MODULE_6___default().bool),
  scale: prop_types__WEBPACK_IMPORTED_MODULE_6___default().shape({
    x: victory_core__WEBPACK_IMPORTED_MODULE_12__.scale,
    y: victory_core__WEBPACK_IMPORTED_MODULE_12__.scale
  }),
  style: prop_types__WEBPACK_IMPORTED_MODULE_6___default().oneOfType([(prop_types__WEBPACK_IMPORTED_MODULE_6___default().object), (prop_types__WEBPACK_IMPORTED_MODULE_6___default().array)]),
  text: prop_types__WEBPACK_IMPORTED_MODULE_6___default().oneOfType([(prop_types__WEBPACK_IMPORTED_MODULE_6___default().string), (prop_types__WEBPACK_IMPORTED_MODULE_6___default().number), (prop_types__WEBPACK_IMPORTED_MODULE_6___default().func), (prop_types__WEBPACK_IMPORTED_MODULE_6___default().array)]),
  theme: (prop_types__WEBPACK_IMPORTED_MODULE_6___default().object),
