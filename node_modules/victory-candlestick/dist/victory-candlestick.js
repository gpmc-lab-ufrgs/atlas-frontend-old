...
var getCandleWidth = function (candleWidth, props) {
  ...
  if (candleWidth) {
    return lodash_isFunction__WEBPACK_IMPORTED_MODULE_0___default()(candleWidth) ? victory_core__WEBPACK_IMPORTED_MODULE_5__.evaluateProp(candleWidth, props) : candleWidth;
  } else if (style.width) {
    return style.width;
  }
...
var getCandleProps = function (props, style) {
  ...
  return {
    ...
    style: victory_core__WEBPACK_IMPORTED_MODULE_5__.omit(style, ["width"]),
...
var evaluateProps = function (props) {
   ...
   * `tabIndex`
   */
  var style = victory_core__WEBPACK_IMPORTED_MODULE_5__.evaluateStyle(lodash_assign__WEBPACK_IMPORTED_MODULE_2___default()({
    stroke: "black"
  }, props.style), props);
  var candleWidth = getCandleWidth(props.candleWidth, lodash_assign__WEBPACK_IMPORTED_MODULE_2___default()({}, props, {
    style: style
  }));
  var ariaLabel = victory_core__WEBPACK_IMPORTED_MODULE_5__.evaluateProp(props.ariaLabel, props);
  var desc = victory_core__WEBPACK_IMPORTED_MODULE_5__.evaluateProp(props.desc, props);
  var id = victory_core__WEBPACK_IMPORTED_MODULE_5__.evaluateProp(props.id, props);
  var tabIndex = victory_core__WEBPACK_IMPORTED_MODULE_5__.evaluateProp(props.tabIndex, props);
...
Candle.propTypes = _objectSpread(_objectSpread({}, victory_core__WEBPACK_IMPORTED_MODULE_6__.primitiveProps), {}, {
  candleRatio: (prop_types__WEBPACK_IMPORTED_MODULE_4___default().number),
  candleWidth: prop_types__WEBPACK_IMPORTED_MODULE_4___default().oneOfType([(prop_types__WEBPACK_IMPORTED_MODULE_4___default().number), (prop_types__WEBPACK_IMPORTED_MODULE_4___default().func)]),
  close: (prop_types__WEBPACK_IMPORTED_MODULE_4___default().number),
  ...
  high: (prop_types__WEBPACK_IMPORTED_MODULE_4___default().number),
  lineComponent: (prop_types__WEBPACK_IMPORTED_MODULE_4___default().element),
  low: (prop_types__WEBPACK_IMPORTED_MODULE_4___default().number),
  open: (prop_types__WEBPACK_IMPORTED_MODULE_4___default().number),
  rectComponent: (prop_types__WEBPACK_IMPORTED_MODULE_4___default().element),
  wickStrokeWidth: (prop_types__WEBPACK_IMPORTED_MODULE_4___default().number),
...
var VictoryCandlestick = /*#__PURE__*/function (_React$Component) {
  ...
  _createClass(VictoryCandlestick, [{
      ...
      var labelComponents = lodash_flatten__WEBPACK_IMPORTED_MODULE_0___default()(types.map(function (type) {
        var components = _this.dataKeys.map(function (key, index) {
          ...
          if (labelProps.text !== undefined && labelProps.text !== null) {
            return /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_3___default().cloneElement(baseComponent, labelProps);
          }
    ...
    value: function render() {
      ...
      var container = /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_3___default().cloneElement(props.containerComponent, victory_core__WEBPACK_IMPORTED_MODULE_5__.getSafeUserProps(props));
...
_defineProperty(VictoryCandlestick, "defaultTransitions", victory_core__WEBPACK_IMPORTED_MODULE_6__.discreteTransitions());

_defineProperty(VictoryCandlestick, "propTypes", _objectSpread(_objectSpread(_objectSpread({}, victory_core__WEBPACK_IMPORTED_MODULE_7__.baseProps), victory_core__WEBPACK_IMPORTED_MODULE_7__.dataProps), {}, {
  candleColors: prop_types__WEBPACK_IMPORTED_MODULE_2___default().shape({
    positive: (prop_types__WEBPACK_IMPORTED_MODULE_2___default().string),
    negative: (prop_types__WEBPACK_IMPORTED_MODULE_2___default().string)
  }),
  candleRatio: (prop_types__WEBPACK_IMPORTED_MODULE_2___default().number),
  candleWidth: prop_types__WEBPACK_IMPORTED_MODULE_2___default().oneOfType([(prop_types__WEBPACK_IMPORTED_MODULE_2___default().func), (prop_types__WEBPACK_IMPORTED_MODULE_2___default().number)]),
  close: prop_types__WEBPACK_IMPORTED_MODULE_2___default().oneOfType([(prop_types__WEBPACK_IMPORTED_MODULE_2___default().func), victory_core__WEBPACK_IMPORTED_MODULE_8__.allOfType([victory_core__WEBPACK_IMPORTED_MODULE_8__.integer, victory_core__WEBPACK_IMPORTED_MODULE_8__.nonNegative]), (prop_types__WEBPACK_IMPORTED_MODULE_2___default().string), prop_types__WEBPACK_IMPORTED_MODULE_2___default().arrayOf((prop_types__WEBPACK_IMPORTED_MODULE_2___default().string))]),
  closeLabelComponent: (prop_types__WEBPACK_IMPORTED_MODULE_2___default().element),
  closeLabels: prop_types__WEBPACK_IMPORTED_MODULE_2___default().oneOfType([(prop_types__WEBPACK_IMPORTED_MODULE_2___default().func), (prop_types__WEBPACK_IMPORTED_MODULE_2___default().array), (prop_types__WEBPACK_IMPORTED_MODULE_2___default().bool)]),
  events: prop_types__WEBPACK_IMPORTED_MODULE_2___default().arrayOf(prop_types__WEBPACK_IMPORTED_MODULE_2___default().shape({
    target: prop_types__WEBPACK_IMPORTED_MODULE_2___default().oneOf(["data", "labels", "open", "openLabels", "close", "closeLabels", "low", "lowLabels", "high", "highLabels"]),
    eventKey: prop_types__WEBPACK_IMPORTED_MODULE_2___default().oneOfType([(prop_types__WEBPACK_IMPORTED_MODULE_2___default().array), victory_core__WEBPACK_IMPORTED_MODULE_8__.allOfType([victory_core__WEBPACK_IMPORTED_MODULE_8__.integer, victory_core__WEBPACK_IMPORTED_MODULE_8__.nonNegative]), (prop_types__WEBPACK_IMPORTED_MODULE_2___default().string)]),
    eventHandlers: (prop_types__WEBPACK_IMPORTED_MODULE_2___default().object)
  })),
  high: prop_types__WEBPACK_IMPORTED_MODULE_2___default().oneOfType([(prop_types__WEBPACK_IMPORTED_MODULE_2___default().func), victory_core__WEBPACK_IMPORTED_MODULE_8__.allOfType([victory_core__WEBPACK_IMPORTED_MODULE_8__.integer, victory_core__WEBPACK_IMPORTED_MODULE_8__.nonNegative]), (prop_types__WEBPACK_IMPORTED_MODULE_2___default().string), prop_types__WEBPACK_IMPORTED_MODULE_2___default().arrayOf((prop_types__WEBPACK_IMPORTED_MODULE_2___default().string))]),
  highLabelComponent: (prop_types__WEBPACK_IMPORTED_MODULE_2___default().element),
  highLabels: prop_types__WEBPACK_IMPORTED_MODULE_2___default().oneOfType([(prop_types__WEBPACK_IMPORTED_MODULE_2___default().func), (prop_types__WEBPACK_IMPORTED_MODULE_2___default().array), (prop_types__WEBPACK_IMPORTED_MODULE_2___default().bool)]),
  labelOrientation: prop_types__WEBPACK_IMPORTED_MODULE_2___default().oneOfType([prop_types__WEBPACK_IMPORTED_MODULE_2___default().oneOf(["top", "bottom", "left", "right"]), prop_types__WEBPACK_IMPORTED_MODULE_2___default().shape({
    open: prop_types__WEBPACK_IMPORTED_MODULE_2___default().oneOf(["top", "bottom", "left", "right"]),
    close: prop_types__WEBPACK_IMPORTED_MODULE_2___default().oneOf(["top", "bottom", "left", "right"]),
    low: prop_types__WEBPACK_IMPORTED_MODULE_2___default().oneOf(["top", "bottom", "left", "right"]),
    high: prop_types__WEBPACK_IMPORTED_MODULE_2___default().oneOf(["top", "bottom", "left", "right"])
  })]),
  low: prop_types__WEBPACK_IMPORTED_MODULE_2___default().oneOfType([(prop_types__WEBPACK_IMPORTED_MODULE_2___default().func), victory_core__WEBPACK_IMPORTED_MODULE_8__.allOfType([victory_core__WEBPACK_IMPORTED_MODULE_8__.integer, victory_core__WEBPACK_IMPORTED_MODULE_8__.nonNegative]), (prop_types__WEBPACK_IMPORTED_MODULE_2___default().string), prop_types__WEBPACK_IMPORTED_MODULE_2___default().arrayOf((prop_types__WEBPACK_IMPORTED_MODULE_2___default().string))]),
  lowLabelComponent: (prop_types__WEBPACK_IMPORTED_MODULE_2___default().element),
  lowLabels: prop_types__WEBPACK_IMPORTED_MODULE_2___default().oneOfType([(prop_types__WEBPACK_IMPORTED_MODULE_2___default().func), (prop_types__WEBPACK_IMPORTED_MODULE_2___default().array), (prop_types__WEBPACK_IMPORTED_MODULE_2___default().bool)]),
  open: prop_types__WEBPACK_IMPORTED_MODULE_2___default().oneOfType([(prop_types__WEBPACK_IMPORTED_MODULE_2___default().func), victory_core__WEBPACK_IMPORTED_MODULE_8__.allOfType([victory_core__WEBPACK_IMPORTED_MODULE_8__.integer, victory_core__WEBPACK_IMPORTED_MODULE_8__.nonNegative]), (prop_types__WEBPACK_IMPORTED_MODULE_2___default().string), prop_types__WEBPACK_IMPORTED_MODULE_2___default().arrayOf((prop_types__WEBPACK_IMPORTED_MODULE_2___default().string))]),
  openLabelComponent: (prop_types__WEBPACK_IMPORTED_MODULE_2___default().element),
  openLabels: prop_types__WEBPACK_IMPORTED_MODULE_2___default().oneOfType([(prop_types__WEBPACK_IMPORTED_MODULE_2___default().func), (prop_types__WEBPACK_IMPORTED_MODULE_2___default().array), (prop_types__WEBPACK_IMPORTED_MODULE_2___default().bool)]),
  style: prop_types__WEBPACK_IMPORTED_MODULE_2___default().shape({
    ...
    closeLabels: (prop_types__WEBPACK_IMPORTED_MODULE_2___default().object),
    open: (prop_types__WEBPACK_IMPORTED_MODULE_2___default().object),
    openLabels: (prop_types__WEBPACK_IMPORTED_MODULE_2___default().object),
    high: (prop_types__WEBPACK_IMPORTED_MODULE_2___default().object),
    highLabels: (prop_types__WEBPACK_IMPORTED_MODULE_2___default().object),
    low: (prop_types__WEBPACK_IMPORTED_MODULE_2___default().object),
    lowLabels: (prop_types__WEBPACK_IMPORTED_MODULE_2___default().object)
  }),
  wickStrokeWidth: (prop_types__WEBPACK_IMPORTED_MODULE_2___default().number)
}));

_defineProperty(VictoryCandlestick, "defaultProps", {
  defaultCandleWidth: 8,
  containerComponent: /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_3___default().createElement(victory_core__WEBPACK_IMPORTED_MODULE_9__["default"], null),
  data: defaultData,
  dataComponent: /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_3___default().createElement(_candle__WEBPACK_IMPORTED_MODULE_10__["default"], null),
  groupComponent: /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_3___default().createElement("g", {
    role: "presentation"
  }),
  labelComponent: /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_3___default().createElement(victory_core__WEBPACK_IMPORTED_MODULE_11__["default"], null),
  highLabelComponent: /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_3___default().createElement(victory_core__WEBPACK_IMPORTED_MODULE_11__["default"], null),
  lowLabelComponent: /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_3___default().createElement(victory_core__WEBPACK_IMPORTED_MODULE_11__["default"], null),
  openLabelComponent: /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_3___default().createElement(victory_core__WEBPACK_IMPORTED_MODULE_11__["default"], null),
  closeLabelComponent: /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_3___default().createElement(victory_core__WEBPACK_IMPORTED_MODULE_11__["default"], null),
  samples: 50,
  sortOrder: "ascending",
  standalone: true,
...
/* harmony import */ var victory_vendor_d3_ease__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! victory-vendor/d3-ease */ "../../victory-vendor/es/d3-ease.js");
...
var VictoryAnimation = /*#__PURE__*/function (_React$Component) {
  ...
  function VictoryAnimation(props, context) {
    ...
    _this.ease = victory_vendor_d3_ease__WEBPACK_IMPORTED_MODULE_3__[_this.toNewName(_this.props.easing)];
    /*
...
var VictoryTransition = /*#__PURE__*/function (_React$Component) {
  ...
  _createClass(VictoryTransition, [{
    ...
    value: function render() {
      ...
      return /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_4___default().createElement(_victory_animation_victory_animation__WEBPACK_IMPORTED_MODULE_10__["default"], _extends({}, combinedProps.animate, {
        data: propsToAnimate
      }), function (newProps) {
...
/* harmony import */ var _victory_util_user_props__WEBPACK_IMPORTED_MODULE_13__ = __webpack_require__(/*! ../victory-util/user-props */ "../../victory-core/es/victory-util/user-props.js");
    ...
    _createClass(addEvents, [{
      ...
      value: function renderData(props) {
        ...
        var dataComponent = props.dataComponent,
            labelComponent = props.labelComponent,
            groupComponent = props.groupComponent;
        var userProps = _victory_util_user_props__WEBPACK_IMPORTED_MODULE_13__.getSafeUserProps(props);
        var dataComponents = this.dataKeys.reduce(function (validDataComponents, _dataKey, index) {
        ...
        var group = /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_9___default().cloneElement(groupComponent, userProps, children);
