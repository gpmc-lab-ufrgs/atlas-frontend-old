...
/* harmony import */ var _helper_methods__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./helper-methods */ "./helper-methods.js");
...
var VictoryStack = function (initialProps) {
  ...
  var childComponents = react__WEBPACK_IMPORTED_MODULE_4___default().Children.toArray(modifiedProps.children);
  var calculatedProps = (0,_helper_methods__WEBPACK_IMPORTED_MODULE_8__.useMemoizedProps)(modifiedProps);
  var domain = calculatedProps.domain,
      scale = calculatedProps.scale,
      style = calculatedProps.style,
      origin = calculatedProps.origin;
  var newChildren = react__WEBPACK_IMPORTED_MODULE_4___default().useMemo(function () {
    ...
    var orderedChildren = children.map(function (child, index) {
      ...
      return /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_4___default().cloneElement(child, childProps);
    });
    /*
  ...
  var containerProps = react__WEBPACK_IMPORTED_MODULE_4___default().useMemo(function () {
    if (standalone) {
      return {
        domain: domain,
        scale: scale,
  ...
  var userProps = react__WEBPACK_IMPORTED_MODULE_4___default().useMemo(function () {
    return victory_core__WEBPACK_IMPORTED_MODULE_9__.getSafeUserProps(initialProps);
  }, [initialProps]);
  var container = react__WEBPACK_IMPORTED_MODULE_4___default().useMemo(function () {
    if (standalone) {
      ...
      return /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_4___default().cloneElement(containerComponent, defaultContainerProps);
    }

    return /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_4___default().cloneElement(groupComponent, userProps);
  }, [groupComponent, standalone, containerComponent, containerProps, userProps]);
  var events = react__WEBPACK_IMPORTED_MODULE_4___default().useMemo(function () {
    return victory_core__WEBPACK_IMPORTED_MODULE_10__.getAllEvents(props);
  }, [props]);
  var previousProps = victory_core__WEBPACK_IMPORTED_MODULE_11__.usePreviousProps(initialProps);
  ...
  if (!lodash_isEmpty__WEBPACK_IMPORTED_MODULE_0___default()(events)) {
    return /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_4___default().createElement(victory_shared_events__WEBPACK_IMPORTED_MODULE_12__["default"], {
      container: container,
      eventKey: eventKey,
      events: events,
  ...
  return /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_4___default().cloneElement(container, container.props, newChildren);
};

VictoryStack.propTypes = _objectSpread(_objectSpread({}, victory_core__WEBPACK_IMPORTED_MODULE_13__.baseProps), {}, {
  bins: prop_types__WEBPACK_IMPORTED_MODULE_3___default().oneOfType([prop_types__WEBPACK_IMPORTED_MODULE_3___default().arrayOf(prop_types__WEBPACK_IMPORTED_MODULE_3___default().oneOfType([victory_core__WEBPACK_IMPORTED_MODULE_14__.nonNegative, prop_types__WEBPACK_IMPORTED_MODULE_3___default().instanceOf(Date)])), victory_core__WEBPACK_IMPORTED_MODULE_14__.nonNegative]),
  ...
  fillInMissingData: (prop_types__WEBPACK_IMPORTED_MODULE_3___default().bool),
  ...
  xOffset: (prop_types__WEBPACK_IMPORTED_MODULE_3___default().number)
});
VictoryStack.defaultProps = {
  containerComponent: /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_4___default().createElement(victory_core__WEBPACK_IMPORTED_MODULE_15__["default"], null),
...
var VictoryStackMemo = /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_4___default().memo(VictoryStack, (react_fast_compare__WEBPACK_IMPORTED_MODULE_5___default()));
...
VictoryStackMemo.getChildren = _helper_methods__WEBPACK_IMPORTED_MODULE_8__.getChildren;
