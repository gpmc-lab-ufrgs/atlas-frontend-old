  ...
  return _class = /*#__PURE__*/function (_base) {
    ...
    _createClass(VictorySelectionContainer, [{
      ...
      value: function getRect(props) {
        ...
        return y2 && x2 && x1 && y1 ? /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_1___default().cloneElement(selectionComponent, {
      ...
      value: function getChildren(props) {
        return [].concat(_toConsumableArray(react__WEBPACK_IMPORTED_MODULE_1___default().Children.toArray(props.children)), [this.getRect(props)]);
      }
    }]);

    return VictorySelectionContainer;
  }(base), _defineProperty(_class, "displayName", "VictorySelectionContainer"), _defineProperty(_class, "propTypes", _objectSpread(_objectSpread({}, victory_core__WEBPACK_IMPORTED_MODULE_2__["default"].propTypes), {}, {
    activateSelectedData: (prop_types__WEBPACK_IMPORTED_MODULE_0___default().bool),
    allowSelection: (prop_types__WEBPACK_IMPORTED_MODULE_0___default().bool),
    disable: (prop_types__WEBPACK_IMPORTED_MODULE_0___default().bool),
    onSelection: (prop_types__WEBPACK_IMPORTED_MODULE_0___default().func),
    onSelectionCleared: (prop_types__WEBPACK_IMPORTED_MODULE_0___default().func),
    selectionBlacklist: prop_types__WEBPACK_IMPORTED_MODULE_0___default().arrayOf((prop_types__WEBPACK_IMPORTED_MODULE_0___default().string)),
    selectionComponent: (prop_types__WEBPACK_IMPORTED_MODULE_0___default().element),
    selectionDimension: prop_types__WEBPACK_IMPORTED_MODULE_0___default().oneOf(["x", "y"]),
    selectionStyle: (prop_types__WEBPACK_IMPORTED_MODULE_0___default().object)
  })), _defineProperty(_class, "defaultProps", _objectSpread(_objectSpread({}, victory_core__WEBPACK_IMPORTED_MODULE_2__["default"].defaultProps), {}, {
    activateSelectedData: true,
    allowSelection: true,
    selectionComponent: /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_1___default().createElement(victory_core__WEBPACK_IMPORTED_MODULE_3__["default"], null),
    selectionStyle: {
      stroke: "transparent",
      fill: "black",
      fillOpacity: 0.1
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (selectionContainerMixin(victory_core__WEBPACK_IMPORTED_MODULE_2__["default"]));
