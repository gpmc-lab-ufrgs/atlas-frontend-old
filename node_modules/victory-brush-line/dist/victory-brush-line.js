...
/* harmony import */ var victory_core__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! victory-core */ "../../victory-core/es/victory-util/collection.js");
...
var getScale = function (props) {
  ...
  var fallbackScale = victory_core__WEBPACK_IMPORTED_MODULE_7__.getBaseScale(props, dimension);
  var range = victory_core__WEBPACK_IMPORTED_MODULE_8__.getRange(props, dimension);
  var domain = victory_core__WEBPACK_IMPORTED_MODULE_9__.getDomainFromProps(props, dimension) || [0, 1];
...
var withinBound = function (value, bound) {
  return value >= victory_core__WEBPACK_IMPORTED_MODULE_10__.getMinValue(bound) && value <= victory_core__WEBPACK_IMPORTED_MODULE_10__.getMaxValue(bound);
};

var getBrushDomain = function (brushDomain, fullDomain) {
  if (brushDomain) {
    var brushMin = victory_core__WEBPACK_IMPORTED_MODULE_10__.getMinValue(brushDomain);
    var brushMax = victory_core__WEBPACK_IMPORTED_MODULE_10__.getMaxValue(brushDomain);
    var domainMin = victory_core__WEBPACK_IMPORTED_MODULE_10__.getMinValue(fullDomain);
    var domainMax = victory_core__WEBPACK_IMPORTED_MODULE_10__.getMaxValue(fullDomain);
  ...
  _createClass(VictoryBrushLine, [{
    ...
    value: function renderHandles(props) {
      ...
      var minDatum = lodash_assign__WEBPACK_IMPORTED_MODULE_3___default()({
        handleValue: victory_core__WEBPACK_IMPORTED_MODULE_10__.getMinValue(brushDomain)
      }, datum);

      var maxDatum = lodash_assign__WEBPACK_IMPORTED_MODULE_3___default()({
        handleValue: victory_core__WEBPACK_IMPORTED_MODULE_10__.getMaxValue(brushDomain)
      }, datum);

      var minHandleProps = lodash_assign__WEBPACK_IMPORTED_MODULE_3___default()({
        key: "".concat(id, "-min"),
        style: victory_core__WEBPACK_IMPORTED_MODULE_8__.evaluateStyle(style, {
          datum: minDatum,
    ...
    value: function renderBrush(props) {
      ...
      var style = victory_core__WEBPACK_IMPORTED_MODULE_8__.evaluateStyle(baseStyle, {
        datum: datum,
...
_defineProperty(VictoryBrushLine, "propTypes", {
  allowDrag: (prop_types__WEBPACK_IMPORTED_MODULE_5___default().bool),
  allowDraw: (prop_types__WEBPACK_IMPORTED_MODULE_5___default().bool),
  allowResize: (prop_types__WEBPACK_IMPORTED_MODULE_5___default().bool),
  brushAreaComponent: (prop_types__WEBPACK_IMPORTED_MODULE_5___default().element),
  brushAreaStyle: (prop_types__WEBPACK_IMPORTED_MODULE_5___default().object),
  brushAreaWidth: (prop_types__WEBPACK_IMPORTED_MODULE_5___default().number),
  brushComponent: (prop_types__WEBPACK_IMPORTED_MODULE_5___default().element),
  brushDimension: prop_types__WEBPACK_IMPORTED_MODULE_5___default().oneOf(["x", "y"]),
  brushDomain: (prop_types__WEBPACK_IMPORTED_MODULE_5___default().array),
  brushStyle: (prop_types__WEBPACK_IMPORTED_MODULE_5___default().object),
  brushWidth: (prop_types__WEBPACK_IMPORTED_MODULE_5___default().number),
  className: (prop_types__WEBPACK_IMPORTED_MODULE_5___default().string),
  dimension: prop_types__WEBPACK_IMPORTED_MODULE_5___default().oneOf(["x", "y"]),
  disable: (prop_types__WEBPACK_IMPORTED_MODULE_5___default().bool),
  ...
  handleComponent: (prop_types__WEBPACK_IMPORTED_MODULE_5___default().element),
  handleStyle: (prop_types__WEBPACK_IMPORTED_MODULE_5___default().object),
  handleWidth: (prop_types__WEBPACK_IMPORTED_MODULE_5___default().number),
  ...
  onBrushDomainChange: (prop_types__WEBPACK_IMPORTED_MODULE_5___default().func),
  scale: (prop_types__WEBPACK_IMPORTED_MODULE_5___default().object),
    ...
    eventHandlers: {
      onMouseEnter: function (evt, targetProps) {
        ...
        var activeBrushes = {
          ...
          brush: withinBound(position, range) && !react_fast_compare__WEBPACK_IMPORTED_MODULE_6___default()(fullDomain, currentDomain),
      ...
      onMouseDown: function (evt, targetProps) {
        ...
        } else if (withinBound(position, range) && !react_fast_compare__WEBPACK_IMPORTED_MODULE_6___default()(fullDomain, currentDomain)) {
      ...
      onMouseMove: function (evt, targetProps) {
        ...
        var activeBrushes = {
          brushArea: !targetProps.brushDomain,
          brush: withinBound(position, initialRange) && !react_fast_compare__WEBPACK_IMPORTED_MODULE_6___default()(fullDomain, domain),
          minHandle: activeHandle === "min" || activeHandle === "both",
